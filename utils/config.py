...
_C.DATA.TRAIN_FILE = ''
_C.DATA.VAL_FILE = ''
_C.DATA.DATASET = 'dfew'
_C.DATA.INPUT_SIZE = 224
_C.DATA.NUM_FRAMES = 16
_C.DATA.NUM_DIVIDE = 4
_C.DATA.NUM_CLASSES = 7
_C.DATA.LABEL_LIST = 'labels2prompt/dfew_7_AUE_labels.csv'
...
_C.MODEL.PRETRAINED = 'checkpoints/ViT-B-16.pt'
...
# -----------------------------------------------------------------------------
_C.AUG = CN()
_C.AUG.LABEL_SMOOTH = 0.1#0.1
_C.AUG.COLOR_JITTER = 0.8
_C.AUG.GRAY_SCALE = 0.2
_C.AUG.MIXUP = 0.8#0.8
_C.AUG.CUTMIX = 1.0
